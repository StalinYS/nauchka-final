    ...
    public partial class Result : Form
    {
        ...
        private void Result_Load(object sender, EventArgs e)
        {
            ...
            var elemList =
                ...
                where ((string)el.Element("group")).StartsWith(n)
                select el;
           ...
           subject = subList.First();
            ...
            schoolYear = (month > 8 && month <= 12) ? year + "/" + (year + 1) : (year - 1) + "/" + year;

            semester = (month > 8 && month <= 12) ? Int32.Parse(courseNum) + 1 : Int32.Parse(courseNum) + 2;
        }
